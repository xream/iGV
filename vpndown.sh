...
route delete 216.218.207.0/24 $vpngw
# login.facebook.com
...
route delete 89.200.143.0/24 $vpngw
# for Google
...
route delete 72.14.203.0/24 $vpngw
# for all facebook
...
# s.nexttv.com.tw
route delete 203.69.138.0/24 $vpngw
# {www|api}.twitter.com
...
route delete 199.59.148.0/24 $vpngw
# m.wikipedia.org
route delete 208.80.154.0/24 $vpngw
# blogs.yahoo.co.jp
...
# tw.myblog.yahoo.com
route delete 119.160.242.0/24 $vpngw
# for all TW Yahoo
...
# for vimeo
# av.vimeo.com
route delete 64.211.21.0/24 $vpngw
...
# f5.wretch.yimg.com
route delete 119.160.252.0/24 $vpngw
# pic.wretch.cc
